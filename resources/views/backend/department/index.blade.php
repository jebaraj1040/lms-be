...
<script>
    ...
    function fetchTable() 
    {
        ...
        dTable = table.DataTable({
            ...
            // stateSave: true,
            ajax: {
                url: '{{route("admin.departments.get-department-list")}}',
                type: 'POST',
                dataType:'json',
                data:{_token: '{{csrf_token()}}',status:status},
            },
            aoColumnDefs:[{className:"dt-center",bSortable:false,aTargets:[0,5]},
            {className:"dt-left",bSortable:true,aTargets:[1,2,3,4,]}
        ],
            columns: [
                {data:'sno'},
                {data:'departmentName'},
